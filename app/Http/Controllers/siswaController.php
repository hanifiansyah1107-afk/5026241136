...
class SiswaController extends Controller
{
    public function index()
    {
        ...
        return view('index_siswa', compact('siswa'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('index_siswa')->with('success', 'Data siswa berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $nrp)
    {
        ...
        return redirect()->route('index_siswa')->with('success', 'Data siswa berhasil diubah.');
    }
    ...
    public function destroy($nrp)
    {
        ...
        return redirect()->route('index_siswa')->with('success', 'Data siswa berhasil dihapus.');
    }
}
